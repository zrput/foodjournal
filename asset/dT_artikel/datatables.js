 ...
 *   https://datatables.net/download/#bs4/dt-1.13.5/fc-4.3.0/sb-1.5.0/sp-2.2.0
 *
 * Included libraries:
 *   DataTables 1.13.5, FixedColumns 4.3.0, SearchBuilder 1.5.0, SearchPanes 2.2.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.13.5/fc-4.3.0/sb-1.5.0/sp-2.2.0",
