		...
		Ne =
			...
			(w.defaults = {
				...
				oLanguage: {
					...
					sEmptyTable: "",
					sInfo: "Menampilkan _START_ sampai _END_ dari _TOTAL_ Artikel",
					sInfoEmpty: "Menampilkan 0 sampai 0 of 0 Artikel",
					sInfoFiltered: "(di-filter from _MAX_ total data)",
					sInfoPostFix: "",
					sDecimal: "",
					sThousands: ",",
...
!(function (e) {
		...
		? ((i = require("jquery")),
		  ...
		  "undefined" == typeof window
				? (module.exports = function (t, s) {
						return (
							(t = t || window), (s = s || i(t)), o(t, s), e(s, 0, t.document)
						);
				  })
				: (o(window, i), (module.exports = e(i, window, window.document))))
	...
	function r(t, s) {
		...
		if (i && i.versionCheck && i.versionCheck("1.10.0"))
			return (
				(t = new i.Api(t)),
				(this.classes = A.extend(!0, {}, r.classes)),
				(this.c = A.extend(!0, {}, r.defaults, s)),
				(s && s.left !== F) ||
	...
	return (
		(r.prototype.left = function (t) {
			return t !== F
				? (0 <= t &&
						t <= this.s.dt.columns().count() &&
						((this.c.left = t), this._addStyles()),
				  this)
				: this.c.left;
		}),
		(r.prototype.right = function (t) {
			return t !== F
				? (0 <= t &&
						t <= this.s.dt.columns().count() &&
						((this.c.right = t), this._addStyles()),
				  this)
				: this.c.right;
		}),
		(r.prototype._addStyles = function () {
				...
				if ((0 < c && a.set(c - 1, n), f.visible())) {
					...
					if (c - n < this.c.left) {
						if (
							...
							for (var g = c; g + 1 < l; ) {
								if (
									(S = this.s.dt.column(g - 1, { page: "current" })).visible()
								) {
									(d += A(S.nodes()[0]).outerWidth()),
										(r +=
											S.header() || S.footer()
												? A(S.header()).outerWidth()
												: 0);
									break;
								}
								g--;
						...
						for (var C = 0, p = h; C < p.length; C++) {
							var x = p[C];
							A(A(x).children()[c - n])
								.css(this._getCellCSS(!1, d, "left"))
								.addClass(this.classes.fixedLeft);
						}
						u
							.css(this._getCellCSS(!0, r, "left"))
							.addClass(this.classes.fixedLeft),
							m
								.css(this._getCellCSS(!0, r, "left"))
								.addClass(this.classes.fixedLeft);
						...
						u.hasClass(this.classes.fixedLeft) &&
							...
							m.hasClass(this.classes.fixedLeft) &&
								m
									.css(this._clearCellCSS("left"))
									.removeClass(this.classes.fixedLeft);
					}
			...
			for (var B = 0, k = 0, y = 0, c = l - 1; 0 <= c; c--)
				if ((f = this.s.dt.column(c)).visible()) {
					...
					if ((_ === F && (_ = n), c + y >= l - this.c.right)) {
						...
						u
							.css(this._getCellCSS(!0, k, "right"))
							.addClass(this.classes.fixedRight),
							m
								.css(this._getCellCSS(!0, k, "right"))
								.addClass(this.classes.fixedRight);
						...
						u.hasClass(this.classes.fixedRight) &&
							...
							m.hasClass(this.classes.fixedRight) &&
								m
									.css(this._clearCellCSS("right"))
									.removeClass(this.classes.fixedRight);
					}
			...
			s &&
				...
				i &&
					(this.s.rtl
						? (this.dom.leftBottomBlocker.outerHeight(o),
						  t.append(this.dom.leftBottomBlocker))
						: (this.dom.rightBottomBlocker.outerHeight(o),
		...
		(r.prototype._setKeyTableListener = function () {
			...
			this.s.dt.on("key-focus.dt.dtfc", function (t, s, e) {
				...
				0 < h.c.left &&
					((i = (o = A(h.s.dt.column(h.c.left - 1).header())).offset()),
					(o = o.outerWidth()),
					d.left < i.left + o) &&
					((l = r.scrollLeft()), r.scrollLeft(l - (i.left + o - d.left))),
					0 < h.c.right &&
						((i = h.s.dt.columns().data().toArray().length),
						(o = A(e.node()).outerWidth()),
						(e = A(h.s.dt.column(i - h.c.right).header()).offset()),
						d.left + o > e.left) &&
						((l = r.scrollLeft()), r.scrollLeft(l - (e.left - (d.left + o))));
			}),
		...
		(r.defaults = { i18n: { button: "FixedColumns" }, left: 1, right: 0 }),
		(e = r),
		(i = (A = o).fn.dataTable),
		(o.fn.dataTable.FixedColumns = e),
		(o.fn.DataTable.FixedColumns = e),
		(l = d.Api.register)("fixedColumns()", function () {
			return this;
		}),
		...
		(d.ext.buttons.fixedColumns = {
			action: function (t, s, e, i) {
				o(e).attr("active")
					? (o(e).removeAttr("active").removeClass("active"),
		...
		o(s).on("plugin-init.dt", function (t, s) {
			"dt" !== t.namespace ||
				(!s.oInit.fixedColumns && !d.defaults.fixedColumns) ||
				s._fixedColumns ||
				h(s, null);
		}),
		d
...
!(function (n) {
	...
	"function" == typeof define && define.amd
		...
		? ((d = require("jquery")),
		  (r = function (t, e) {
				e.fn.dataTable || require("datatables.net-bs4")(t, e),
					e.fn.dataTable.SearchBuilder ||
						require("datatables.net-searchbuilder")(t, e);
		  }),
		  "undefined" == typeof window
				? (module.exports = function (t, e) {
						return (
							(t = t || window), (e = e || d(t)), r(t, e), n(e, 0, t.document)
						);
				  })
	...
	return (
		...
		(T.prototype._updateSelection = function (t) {
			...
			a.oFeatures.bProcessing
				? (i._fnProcessingDisplay(a, !0), setTimeout(s, 1))
				: s();
		}),
		...
		(T.defaults = {
			...
			i18n: {
				clearPane: "&times;",
				count: "{total}",
				emptyMessage: "<em>Tidak ada data</em>",
			},
			initCollapsed: !1,
			layout: "auto",
			name: b,
...
!(function (n) {
		...
		? ((a = require("jquery")),
		  ...
		  "undefined" == typeof window
				? (module.exports = function (e, t) {
						return (
							(e = e || window), (t = t || a(e)), s(e, t), n(t, 0, e.document)
						);
				  })
	...
	return (
		e.extend(!0, s.SearchPane.classes, {
