                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between" style="background-color:#7eefb1;">
                            <h5 class="m-3 font-weight-bold text-dark">Edit Data Artikel</h5>
                        ...
                        <div class="container">
                            ...
                            <?php endif; ?>
                            <form action="<?= base_url('Artikel/update_artikel_aksi') ?>" method="POST" enctype="multipart/form-data">

                                <div class="mb-3">
                                    <label for="judul" class="form-label">Judul</label>
                                    <input type="hidden" name="idartikel" value="<?php echo $artikel['idartikel']; ?>">
                                    <input type="text" name="judul" class="form-control" id="judul" value="<?php echo $artikel['judul'] ?>">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="waktu" class="form-control" id="waktu" value="<?= $artikel['waktu'] ?>">
                                ...
                                <div class="mb-3">
                                    <label for="isi" class="form-label">Isi Artikel <span style="color:#999999; font-size:small;">(*Tips : expand kolom isi artikel untuk mempermudah proses edit.)</span></label>
                                    <textarea type="text" name="isi" class="form-control" id="my-textarea" rows="3"><?= $artikel['isi'] ?></textarea>
                                    <?php echo form_error('isi', '<div class="text-small text-danger">', '</div>') ?>

                                    <!-- fix tabs button -->
                                    <script>
                                        document.querySelector('#my-textarea').addEventListener('keydown', function(event) {
                                            if (event.key === 'Tab') {
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="foto" class="form-control" id="foto" accept="image/png, image/jpeg, image/jpg, image/gif" <?= $artikel['foto'] ?>>
                                    <?php echo form_error('foto', '<div class="text-small text-danger">', '</div>') ?>

                                </div>

                                <div class="modal-footer">
                                    <a type="button" class="btn btn-danger" href="<?= base_url('Artikel') ?>"><i class="fa fa-ban"></i> Cancel</a>
                                    <button type="submit" name="tambah" class="btn btn-primary"><i class="fa fa-folder"></i> Simpan</button>
                                </div>
                            </form>
                        </div>
