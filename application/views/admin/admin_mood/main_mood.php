        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Master Data Mood</h1>
                    <p class="mb-4">Ini merupakan halaman untuk mengelola master data mood</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between" style="background-color:#a2dbc8;">
                            <h5 class="m-3 font-weight-bold text-dark">Tabel Data Mood</h5>
                        ...
                        <!-- Modal -->
                        <?php $this->load->view('admin/admin_mood/modal_mood'); ?>
                                ...
                                <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-center" style="background-color:#dcf1eb; color:#747474; font-weight: bold; font-family: 'roboto';">Nama Mood</th>
                                        ...
                                        <?php foreach ($mood as $key) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <?php echo $key['idmood'] ?> <br>

                                                </td>
                                                <td class="text-center"><?php echo $key['ket'] ?></td>
                                                <td class="text-center">
                                                    <!-- Button edit -->
                                                    <button type="submit" data-toggle="modal" data-target="#edit<?php echo $key['idmood']; ?>" class="btn btn-warning"><i class="fa fa-marker"></i> Edit</button>


                                                    <!-- Button Hapus-->
                                                    <button type="reset" data-toggle="modal" data-target="#delete<?php echo $key['idmood']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</button>

                                                    <!-- end hapus modal-->
                                                </td>
                                                <!-- modal edit -->
                                                <div class="modal fade" id="edit<?php echo $key['idmood']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="<?php echo base_url('Admin_Mood/edit_mood') ?>" method="post">
                                                                    <div class="form-group">
                                                                        <label for="Satuan">Nama Mood</label>
                                                                        <input class="form-control" name="id" type="hidden" value="<?php echo $key['idmood'] ?>" required>
                                                                        <input class="form-control" name="nama_mood" value="<?php echo $key['nama_mood'] ?>" required>
                                                                    </div>
                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control" name="ket" value="<?php echo $key['ket'] ?>">
                                                                    </div>
                                                            </div>
                                                ...
                                                <!-- End Modal Edit -->
                                                <!-- hapus Modal-->
                                                <div class="modal fade" id="delete<?php echo $key['idmood']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <center>Yakin Ingin Menghapus Data?</center>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
                                                                <a class="btn btn-danger" href="<?php echo base_url('Admin_Mood/hapus_mood/' . $key['idmood']) ?>">Hapus</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
