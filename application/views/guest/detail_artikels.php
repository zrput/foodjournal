      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navigation">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a href="<?php echo base_url('guest/cari_artikel') ?>" data-toggle="tooltip" title="Cari Artikel" class="nav-link" style="color:#5bddf4; font-size:16px"><ion-icon name="stats-chart-outline"></ion-icon> Artikel</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="<?php echo base_url('auth/signup') ?>" data-toggle="tooltip" title="Ayo bergabung dengan Kami" class="btn btn-info btn-round">Signin</a>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <div class="page-header page-header-small" data-parallax="flase" style="  background-image: url('<?php echo base_url('asset/1.jpg'); ?>');">
      ...
      <div class="container">
        <div class="motto text-center">
          <h2 class="bg-info text-align text-white p-3 rounded" style="font-weight:bold; ">"<?php foreach ($data as $key) : ?>
            <?php echo $key['judul']; ?> "
          <?php endforeach; ?></h2>
          <br>
            ...
            <div class="col-md-8 ml-auto mr-auto">
              ...
              <dd>
                ...
                <h5 class="description"><?php foreach ($artikel as $article) : ?>
                    <img class="mx-auto d-block shadow-lg" src="<?php echo base_url('asset/1.jpg'); ?>" style="width: 600x; height: 400px;" alt="Image Alt Text">
                    <br>
              ...
              ?>
                <div class="col-md-4">
                  <div class="card" style="width: 18rem; height: 37rem; ">
                    <img src="<?php echo base_url('asset/1.jpg'); ?>" class="card-img-top" alt="Image Alt Text">
                    <div class="card-body">
                      ...
                      <form action="<?= base_url('guest/detail_artikel/') ?> " method="post">
                        ...
                        <button data-toggle="tooltip" title="Baca Artikel" class="btn btn-primary" type="submit"><i class="fa fa-eye"></i> <span style=" font-weight: light; font-family: 'roboto'; font-size: 12px;"> Baca Selengkapnya</span> </button>
                      </form>
                    </div>
                  </div>
                </div>
