                        ...
                        <form id="myForm" method="post" action="<?php echo base_url('Makanan/add_makanan'); ?>">
                            <div class="form-inline"><!-- form data -->
                                ...
                                <div class="form-group mx-sm-1 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="nama_makanan" id="carinama" placeholder="Nasi" onblur="removeTrailingSpace()">
                                </div>
                            ...
                            <div class="form-group">
                                <label>Kalori</label>
                                <input type="number" class="form-control" name="kalori" placeholder="Contoh: 100">
                            </div>
