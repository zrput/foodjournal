...
<head>
    ...
    <title>Food Journaling - Catatan Harian</title>
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <p class="text-left " style="color:#747474; font-weight: semi-bold; font-family: 'roboto';">Anda mengalami mood <span style="color:#fe7272; font-weight: bold; font-family: 'Arial';">"<?php foreach ($mood as $key) : $nama = strtoupper($key['nama_mood']) ?>
                                            <?php echo $nama ?>
                                            <?php endforeach; ?>"</p>
                                    <p class="text-left " style="color:#747474; font-weight: semi-bold; font-family: 'roboto';">Berikut ini catatan harian Anda selama 3 hari kebelakang dari tanggal : <span style="color:#747474; font-weight: bold; font-family: 'Roboto';"><?php echo date('d-M-Y ', strtotime($tgl_mood)) ?></span></p>
                                        ...
                                        <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" class="text-center" style="background-color:#bae4d7; color:#747474; font-weight: bold; font-family: 'roboto';">Catatan</th>
                                                </tr>
                                            </thead>
                                            <tfoot>
                                                <tr>
                                            ...
                                            <tbody>
                                                <?php if (empty($data)) { ?>
                                                    <tr>
                                                        <td></td>
                                                        <td></td>
                                                        <td class="text-center" colspan="4">Tidak ada catatan harian yang tercatat pada 3 hari sebelum tanggal <span style="color:#747474; font-weight: bold; font-family: 'Roboto';"><?php echo date('d-M-Y ', strtotime($tgl_mood)) ?></span> </td>
                                                    </tr>
                                                <?php } else { ?>
