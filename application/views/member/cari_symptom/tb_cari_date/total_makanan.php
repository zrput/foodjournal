                    ...
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            <div class="button-container">
                                ...
                                <h3 class="text-center " style="color:#18aee7; font-weight: bold; font-family: 'Arial';"> Total makanan dari gejala <span style="color:#fe7272; font-weight: bold; font-family: 'Arial';">"<?php foreach ($symptom as $key) : $nama = strtoupper($key['nama_symptom']) ?>
                                        <?php echo $nama ?>
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <p class="text-left " style="color:#747474; font-weight: semi-bold; font-family: 'roboto';">Anda mengalami gejala <span style="color:#fe7272; font-weight: bold; font-family: 'Arial';">"<?php foreach ($symptom as $key) : $nama = strtoupper($key['nama_symptom']) ?>
                                            <?php echo $nama ?>
                                            <?php endforeach; ?>"</p>
                                    <p class="text-left " style="color:#747474; font-weight: semi-bold; font-family: 'roboto';">Berikut ini nama makanan dan frekuensi makanan yang anda konsumsi selama 3 hari kebelakang dari tanggal : <span style="color:#747474; font-weight: bold; font-family: 'Roboto';"><?php echo date('d-M-Y ', strtotime($tgl_symptom)) ?></span></p>
