        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Mood</h1>
                    <p class="mb-4">Pada Halaman ini Anda dapat melakukan pencatatan terhadap mood yang dialami setelah mengkonsumsi makanan/minuman</p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <!-- Modal form -->
                            <?php $this->load->view('member/mood/modal_mood'); ?>
                            <div class="container-fluid">
                                <div class="card-body">
                                        ...
                                        <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" class="text-center" style="background-color:#dcf1eb; color:#747474; font-weight: bold; font-family: 'roboto';">Mood</th>
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($mood as $key) : $date = date('d-M-Y H:i', strtotime($key['waktu'])) ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <button type="submit" data-toggle="modal" data-target="#edit<?php echo $key['id_user_mood']; ?>" class="btn btn-warning"><i class="fa fa-marker"></i> Edit</button>
                                                            <button type="reset" data-toggle="modal" data-target="#delete<?php echo $key['id_user_mood']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</button>
