        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Buang Air Besar</h1>
                    <p class="mb-4">Pada Halaman ini Anda dapat melakukan pencatatan buang air besar</p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <!-- Modal -->
                        <?php $this->load->view('member/bab/modal_bab'); ?>
                                ...
                                <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-center" style="background-color:#dcf1eb; color:#747474; font-weight: bold; font-family: 'roboto';">Warna</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($bab as $key) : $date = date('d-M-Y H:i', strtotime($key['waktu'])) ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $key['warna'] ?></td>
                                                <td class="text-center"><?php echo $key['ket_tambahan'] ?></td>
                                                <td class="text-center">
                                                    <!-- Button edit -->
                                                    <button type="submit" data-toggle="modal" data-target="#edit<?php echo $key['id_user_bab']; ?>" class="btn btn-warning"><i class="fa fa-marker"></i> Edit</button>


                                                    <!-- Button Hapus-->
                                                    <button type="reset" data-toggle="modal" data-target="#delete<?php echo $key['id_user_bab']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</button>
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="<?php echo base_url('Bab/edit_bab') ?>" method="post">
                                                                    <div class="form-group">
                                                                        <input type="hidden" class="form-control" name="id" value="<?php echo $key['id_user_bab'] ?>" required>
                                                                        <label for="Satuan">Skala Bristol</label>
                                                                        <select name="bab" class="form-control">
                                                                            <option value="">-- Pilih Skala Bristol</option>
                                                ...
                                                <!-- End Modal Edit -->
                                                <!-- hapus Modal-->
                                                <div class="modal fade" id="delete<?php echo $key['id_user_bab']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
