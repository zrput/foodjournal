        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Pada Halaman ini Anda dapat melakukan pencatatan brustol</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between">
                            <h6 class="m-3 font-weight-bold text-primary">Data table BAB</h6>
                        ...
                        <!-- isi data Table bab --> 
                        <?php $this->load->view('member/bab/table_bab'); ?>
