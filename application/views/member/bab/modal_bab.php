                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form action="<?php echo base_url('Bab/add_bab') ?>" method="post">
                                  <div class="form-group">
                                    <label for="Satuan">Pilih Skala Bristol</label>
                                    <select name="bab" class="form-control">
                                      <option value="">-- Pilih Skala --</option>
                                      <?php foreach ($ket as $option) : ?>
                                        <option value="<?php echo $option['idbab']; ?>"><?php echo $option['idbab']; ?> <br> <?php echo $option['ket']; ?> <br></option>
                                      <?php endforeach; ?>
                                    </select>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="warna" placeholder="Contoh: coklat tua" required>
                                  </div>
                                  <div class="form-group">
